# -*- coding: utf-8 -*-
"""Eason_ML_HW7_sample_code.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11Hdl4Sb3ceDtxin8vGhdzSSN5pdYOfrS

# ML Assignment 7 - Sample Code
...
def train_model(model, criterion, device, dataloaders, dataset_sizes, optimizer, scheduler, num_epochs=25):
  ...
  plt.ylabel('loss')
  plt.legend()
  plt.savefig(os.path.join(result_dir, "valid_loss.png"))
  plt.clf()
